    ...
    public class DbInitializer
    {
        public static void Initialize(AppDbContext context)
        {
            ...
            var Adresses = new Adress[]
            {
                ...
                new Adress{CustomerID=1, StreetAdress="Example of street adress in Lithuania", City="Vilnius", Zip="LT-4000", CountryID=2, Type=Adress.AdressType.Billing},
                new Adress{CustomerID=1, StreetAdress="Example of street adress in Lithuania", City="Vilnius", Zip="LT-4000", CountryID=2, Type=Adress.AdressType.Delivery},
                new Adress{CustomerID=2, StreetAdress="Example of street adress in Estonia", City="Tallin", Zip="EE-4000", CountryID=3, Type=Adress.AdressType.Billing},
                new Adress{CustomerID=2, StreetAdress="Example of street adress in Estonia", City="Tallin", Zip="EE-4000", CountryID=3, Type=Adress.AdressType.Delivery},
            };
